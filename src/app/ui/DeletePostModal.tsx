...
import { removePost } from "../redux/features/auth-slice";
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-80 flex items-center justify-center">
          <div className="bg-white w-60 h-36 rounded-xl flex flex-col items-center justify-center">
            ...
            <div className="grid grid-cols-2 w-60">
              <button className="w-20 m-auto bg-red-800 text-white text-base rounded-2xl hover:cursor-pointer hover:bg-opacity-80" onClick={ () => [deletePost(id), closeModal(), dispatch(removePost(id))] }>Delete</button>
