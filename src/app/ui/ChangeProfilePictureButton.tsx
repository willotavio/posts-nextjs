  ...
  return(
    <div>
      <div className="relative rounded-full my-2 justify-center">
        <Image className="outline outline-4 outline-neutral-200 dark:outline-neutral-800 rounded-full sm:w-[6rem] sm:h-[6rem] w-[5rem] h-[5rem] object-cover flex flex-shrink-0" src={ user.image || '' } alt="profile picture" width={100} height={100} priority={true} />
